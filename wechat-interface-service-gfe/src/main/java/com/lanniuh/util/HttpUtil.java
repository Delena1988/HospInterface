...
import cn.joinhealth.pub_manager.enums.SecretType;
import cn.joinhealth.pub_manager.secret.Exception.SecretException;
import cn.joinhealth.pub_manager.secret.SecretFactory;
...
//            }
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPostHeLe(String url, String param) {
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String serverCode, String secret, String url, Map<String, String> params) {
        ...
        try {
            ...
            if (!StringUtil.isEmpty(serverCode)) {
                ...
                sb.append("sign=" + (URLEncoder.encode(auth, "UTF-8")));
